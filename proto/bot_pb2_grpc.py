...
class BotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.StreamBotLogs = channel.stream_stream(
                '/bot.BotService/StreamBotLogs',
...
def add_BotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamBotLogs': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamBotLogs,
...
class BotService(object):
    ...
    @staticmethod
    def StreamBotLogs(request_iterator,
            target,
            options=(),
